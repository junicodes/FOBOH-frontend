...
> **Note:** The backend uses PostgreSQL in production and SQLite for local development. Ensure the backend is properly configured with the correct database before connecting the frontend.
